...
const FounderModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      ref={modalRef}
      className="fixed inset-0 bg-[#43555d]/20 backdrop-blur-sm flex items-center justify-center z-[1000] hidden opacity-0 p-3 sm:p-4 md:p-6 overflow-y-auto"
      onClick={handleClose}
    >
      <div
        ref={modalContentRef}
        className="relative bg-gradient-to-br from-[#f8efe3] to-[#f5e6d3] text-[#43555d] rounded-3xl shadow-2xl max-w-5xl w-full mx-auto overflow-hidden my-4 sm:my-8"
      ...
      >
        ...
        <button
          onClick={handleClose}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 z-10 text-[#43555d]/60 hover:text-[#43555d] transition-all duration-300 hover:rotate-90 bg-[#D0B4B3]/30 rounded-full p-2 backdrop-blur-sm"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 md:p-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white to-[#f8efe3] rounded-3xl p-4 sm:p-6 border-2 border-[#D0B4B3]/50 shadow-lg">
                ...
                <div className="flex flex-col items-center">
                  <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-[#D0B4B3] shadow-2xl overflow-hidden mb-3 sm:mb-4">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              ...
              <div className="relative bg-white/60 rounded-xl p-2 sm:p-3 text-center border border-[#D0B4B3]/30 hover:bg-white/80 hover:border-[#D0B4B3]/60 transition-all duration-300 shadow-md">
                <div className="text-xl sm:text-2xl mb-1">🌏</div>
                <p className="text-xs text-[#43555d]/60 uppercase">Adventure</p>
                <p className="text-xs sm:text-sm font-semibold text-[#a37b64]">
                  Australia
                </p>
              </div>
          ...
          <div className="space-y-3 sm:space-y-4 text-sm text-[#43555d] leading-relaxed overflow-y-auto max-h-[400px] sm:max-h-[500px] lg:max-h-[600px] pr-2 custom-scrollbar">
            ...
            <div className="bg-white/70 rounded-2xl p-3 sm:p-4 backdrop-blur-sm border border-[#D0B4B3]/40 relative overflow-hidden shadow-md">
              ...
              <p className="mb-3 relative z-10">
                ...
                that was expected of me as the CEO of my family's company wasn't
                the life I wanted. I dreamed of living abroad, exploring the
                world, and creating a life that truly felt like mine.
              </p>
              <p className="mb-3">
                My first solo trip was to Aruba, and that's where it all began.
                Not long after, I moved to New York to study, the only way my
                family would "allow" me to leave the country for a while. A year
                later, I packed my bags again and moved to Australia.
              </p>
              <p>
            ...
            <div className="bg-gradient-to-r from-[#D0B4B3]/30 to-[#a37b64]/30 rounded-2xl p-3 sm:p-4 border border-[#a37b64]/30 relative shadow-md">
              ...
              <p className="mb-3">
                I wanted to share these experiences with other women who shared
                my love for travel.
              </p>
