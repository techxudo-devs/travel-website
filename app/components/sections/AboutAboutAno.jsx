    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:items-end gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          <p className="text-[#D0B4B3] text-lg font-semibold mb-2 uppercase">
            Our Values
          </p>
          ...
          <p className="text-gray-700 text-base sm:text-lg mb-12 max-w-lg mx-auto lg:mx-0">
            We believe travel is more than ticking destinations off a list. It’s
            about self-discovery, courage, and the joy of connecting with others
            who share your spirit of adventure. That’s why we organize group
            experiences, share helpful travel resources, and create
            opportunities for women everywhere to explore the world TOGETHER.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Feature 1 */}
            <div className="flex items-center gap-4 p-6 rounded-xl bg-[#EAF3EF] bg-opacity-70 shadow-sm">
              {/* <Image loading='lazy' className='w-14' src="/aboutc1.svg" alt="" /> */}
              <p className="bg-blue-100 p-3 rounded-full">
                <Cable />
              </p>
              <p className="font-semibold text-gray-800">
                Authentic connection between women
              </p>
            </div>

            {/* Feature 2 */}
            <div className="flex items-center gap-4 p-6 rounded-xl bg-[#F6EFE6] bg-opacity-70 shadow-sm">
              {/* <Image loading='lazy' className='w-14' src="/aboutc2.svg" alt="" /> */}
              <p className="bg-pink-200 p-3 rounded-full">
                <HandFist />
              </p>
            ...
            <div className="flex items-center gap-4 p-6 rounded-xl bg-orange-100 bg-opacity-70 shadow-sm">
              {/* <Image loading='lazy' className='w-14' src="/aboutc3.svg" alt="" /> */}
              <p className="bg-orange-200 p-3 rounded-full">
                <UsersRound />
              </p>
              <p className="font-semibold text-gray-800">
            ...
            <div className="flex items-center gap-4 p-6 rounded-xl bg-green-100 bg-opacity-70 shadow-sm">
              {/* <Image loading='lazy' className='w-14' src="/aboutc4.svg" alt="" /> */}
              <p className="bg-green-200 p-3 rounded-full">
                <BaggageClaim />
              </p>
              <p className="font-semibold text-gray-800">
                Purposeful and meaningful travel
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 p-6 rounded-xl bg-purple-100 bg-opacity-70 shadow-sm">
              {/* <Image loading='lazy' className='w-14' src="/aboutc1.svg" alt="" /> */}
              <p className="bg-purple-200 p-3 rounded-full">
                <Telescope />
              </p>
              <p className="font-semibold text-gray-800">
            ...
            <div className="flex items-center gap-4 p-6 rounded-xl bg-lime-100 bg-opacity-70 shadow-sm">
              {/* <Image loading='lazy' className='w-14' src="/aboutc2.svg" alt="" /> */}
              <p className="bg-lime-200 p-3 rounded-full">
                <ShieldCheck />
              </p>
