    ...
    <section ref={containerRef} className="bg-[#F3F6F5] py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-center text-xl sm:text-2xl md:text-4xl text-gray-900 max-w-5xl mx-auto my-12">
          Founded with a passion for exploration and a commitment to quality,
          Travlo was created to provide a seamless, inspiring travel experience
          for everyone. Over the years, we’ve built a trusted network of local
          guides.
        </p>
