        ...
        <section className="bg-white py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:items-start gap-12">
                ...
                <div className="lg:w-1/2 text-center lg:text-left">
                    <p className="text-[#4E4E4E] text-lg font-semibold mb-2">About Us</p>
                    ...
                    <button className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-full shadow-sm text-[#DAFF97] bg-black hover:bg-green-800 transition-all cursor-pointer duration-300">
                        Contact Us
